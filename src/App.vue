...
<script setup>
    ...
    //Default Starting Color of Model
    var changeColor = ref('#2bff00');
...
<template>
    ...
    <div id="content">
      ...
      <div id="content">
        <GeometryView :radius="slider1" :tube="slider2" :tubeSegments="slider3" :radialSegments="slider4" :meshBoolean="runToggle" :torusColor="changeColor"/>
